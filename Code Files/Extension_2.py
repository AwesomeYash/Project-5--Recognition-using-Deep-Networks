...
def train_and_evaluate(num_conv_layers, filter_size, batch_size, num_epochs, device):
    ...
    model_path = f'saved_models_MNIST/model_layers_{num_conv_layers}_filter_{filter_size}_batch_{batch_size}_epochs_{num_epochs}.pth'
...
def main():
    ...
    os.makedirs('saved_models_MNIST', exist_ok=True)
    # Use CPU
    device = torch.device("cpu")

    # Hyperparameter ranges based on your suggestions
        ...
        for num_layers in conv_layers:
            for batch_size in batch_sizes:
                ...
                if current_batch_size != batch_size and current_batch_size is not None and last_model is not None:
                    ...
                    batch_change_model_path = f'saved_models_MNIST/batch_{current_batch_size}_layers_{last_config[0]}_filter_{last_config[1]}_epochs_{last_config[2]}.pth'
